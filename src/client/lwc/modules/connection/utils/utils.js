...
export const normalizeConfiguration = (rawData, byPassValidation = false) => {
    ...
    return {
        ...
        // password is intentionally excluded — plaintext passwords must not be persisted.
        // USERNAME credential type connections will re-prompt for the password on reconnect.
        instanceUrl: rawData.instanceUrl,
